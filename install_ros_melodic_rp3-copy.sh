...
rosinstall_generator desktop robot rosserial turtlebot3_simulations turtlebot3 xacro diagnostic_msgs interactive_markers urdf geometry geometry2 actionlib angles rosconsole_bridge console_bridge --rosdistro $name_ros_version --deps --wet-only --tar > $name_ros_version-core-wet.rosinstall
wstool init src  $name_ros_version-core-wet.rosinstall

echo "[Install the Turtlebot Packages]"
cd ~/ros_catkin_ws/src
git clone https://github.com/ROBOTIS-GIT/hls_lfcd_lds_driver.git
git clone https://github.com/ROBOTIS-GIT/turtlebot3_msgs.git
git clone https://github.com/ROBOTIS-GIT/turtlebot3.git

echo "[Install Unavailable Dependencies]"
